        ...
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="nav-link" href="{{url('/add_transation')}}">Add Transations</a></li>
                    <li><a class="nav-link" href="{{url('/transation_report')}}">Veiw Reports</a></li>
                    <li><a class="nav-link" href="{{url('/audit_trail')}}">Audit Trail</a></li>
                </ul>
            </li>
            <li class="dropdown">
